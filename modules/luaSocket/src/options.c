...
{
    return -1;//opt_setboolean(L, ps, IPPROTO_TCP, TCP_NODELAY); 
}
...
{
    return -1;//opt_setmembership(L, ps, IPPROTO_IP, IP_ADD_MEMBERSHIP);
}

int opt_ip_drop_membersip(lua_State *L, p_socket ps)
{
    return -1;//opt_setmembership(L, ps, IPPROTO_IP, IP_DROP_MEMBERSHIP);
}
#if 0
/*=========================================================================*\
* Auxiliar functions
