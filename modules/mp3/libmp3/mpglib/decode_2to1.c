...
int synth_2to1_mono(PMPSTR mp, real *bandPtr,unsigned char *samples,int *pnt)
{
  ...
  ret = synth_2to1(mp, bandPtr,0,(unsigned char *) samples_tmp,&pnt1);
  samples += *pnt;
...
int synth_2to1(PMPSTR mp, real *bandPtr,int channel,unsigned char *out,int *pnt)
{
...
int synth_4to1_mono(PMPSTR mp, real *bandPtr,unsigned char *samples,int *pnt)
{
  ...
  ret = synth_4to1(mp, bandPtr,0,(unsigned char *) samples_tmp,&pnt1);
  samples += *pnt;
...
int synth_4to1(PMPSTR mp, real *bandPtr,int channel,unsigned char *out,int *pnt)
{
  static real buffs[2][2][0x110];
  static const int step = 2;
  static int bo = 1;
