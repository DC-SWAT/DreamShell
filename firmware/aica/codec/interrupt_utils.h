...
/*
  ...
  "nacked". The uses has to take care to save registers
  and add the needed code for ISR functions. Some
  macros for this are provided below
*/
 ...
 *    Should be used after ISR_ENTRY_STORE. 
 *
 *****************************************************************************/
...
/*
 * The macros ISR_ENTRY and ISR_EXIT are from the
 * file "armVic.h" by:
 *
